                                        ...
                                        <div className="d-flex flex-wrap flex-stack mb-6 card-header flex-nowrap border-0">
                                            <div className="card-body p-0">
                                                <div className="row mb-7">
                                                    <label className="col-lg-3 fs-6 fw-bolder text-gray-900">Appointment Id</label>
                                                ...
                                                <div className="row mb-7">
                                                    <label className="col-lg-3 fs-6 fw-bolder text-gray-900">Appointment Type</label>
                                                ...
                                                <div className="row mb-7">
                                                    <label className="col-lg-3 fs-6 fw-bolder text-gray-900">Appointment Between</label>
                                                    <div className="col-lg-9 fv-row">
                                                ...
                                                <div className="row mb-7">
                                                    <label className="col-lg-3 fs-6 fw-bolder text-gray-900">Date & Time</label>
                                                    <div className="col-lg-9 fv-row">
                                                    ...
                                                    <div className="row mb-7" style={{ justifyContent: '' }}>
                                                        <div className="col-lg-8 fv-row">
                                                            <div className="symbol-label">
                                                                <img src={Appointment.Appointment_icon} alt={`Property ${Appointment.Appointment_id}`} style={{ width: '30rem' }} />
                                                            </div>
                                                        </div>
                                                    </div>
