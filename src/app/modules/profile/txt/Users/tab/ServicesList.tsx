...
type Updated_by_two = 'Provider' | 'Buyer';
...
const appointments_two: Appointment_two[] = [
    {
        ...
        updated_by_two: 'Provider',
        note_two: 'Appointment Scheduled By Provider.',
    },
    {
        date_time_two: '06-06-2024 18:00',
        status_two: 'Approved',
        discussed_date_time_two: '06-06-2024 18:00',
        updated_by_two: 'Provider',
        note_two: 'Appointment Approved By Provider.',
    },
    {
        date_time_two: '06-06-2024 18:00',
                                                ...
                                                <div id="kt_app_toolbar" className="app-toolbar py-3 py-lg-6">
                                                    ...
                                                    >
                                                        ...
                                                        <div className="d-flex align-items my-2">
                                                            <button
                                                                onClick={handleBackClickService}
                                                                style={{
                                                                    border: 'none',
